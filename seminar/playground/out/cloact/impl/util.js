...
cloact.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__3954__auto__,writer__3955__auto__,opt__3956__auto__){return cljs.core._write.call(null,writer__3955__auto__,"cloact.impl.util/partial-ifn");
});
...
var G__6392__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__3405__auto___6393 = self__.p;if(cljs.core.truth_(or__3405__auto___6393))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__6392 = function (self__,var_args){
var self__ = this;
var a = null;if (arguments.length > 1) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__6392__delegate.call(this,self__,a);};
G__6392.cljs$lang$maxFixedArity = 1;
G__6392.cljs$lang$applyTo = (function (arglist__6394){
var self__ = cljs.core.first(arglist__6394);
var a = cljs.core.rest(arglist__6394);
return G__6392__delegate(self__,a);
});
G__6392.cljs$core$IFn$_invoke$arity$variadic = G__6392__delegate;
return G__6392;
})()
;
cloact.impl.util.partial_ifn.prototype.apply = (function (self__,args6391){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args6391)));
});
cloact.impl.util.partial_ifn.prototype.cljs$core$IFn$_invoke$arity$2 = (function() { 
var G__6395__delegate = function (a){var _ = this;var or__3405__auto___6396 = self__.p;if(cljs.core.truth_(or__3405__auto___6396))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__6395 = function (var_args){
var self__ = this;
var a = null;if (arguments.length > 0) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__6395__delegate.call(this,a);};
G__6395.cljs$lang$maxFixedArity = 0;
G__6395.cljs$lang$applyTo = (function (arglist__6397){
var a = cljs.core.seq(arglist__6397);
return G__6395__delegate(a);
});
...
cloact.impl.util.identical_parts = (function identical_parts(v1,v2){var or__3405__auto__ = (v1 === v2);if(or__3405__auto__)
{return or__3405__auto__;
} else
{var end = cljs.core.count.call(null,v1);var and__3393__auto__ = (end === cljs.core.count.call(null,v2));if(and__3393__auto__)
{var n = 0;while(true){
if((n >= end))
{return true;
} else
...
cloact.impl.util._not_found = (function (){var obj6400 = {};return obj6400;
})();
cloact.impl.util.shallow_equal_maps = (function shallow_equal_maps(x,y){var or__3405__auto__ = (x === y);if(or__3405__auto__)
{return or__3405__auto__;
} else
{var and__3393__auto__ = (cljs.core.count.call(null,x) === cljs.core.count.call(null,y));if(and__3393__auto__)
...
var and__3393__auto__ = cloact.impl.util.identical_parts.call(null,c1,c2);if(and__3393__auto__)
