...
var render_component_to_string__1 = (function (component){var res = cljs.core.atom.call(null,null);render_component_to_string.call(null,component,(function (p1__6080_SHARP_){return cljs.core.reset_BANG_.call(null,res,p1__6080_SHARP_);
}));
...
var G__6081__delegate = function (x,rest){return cljs.core.apply.call(null,cloact.ratom.atom,x,rest);
};
var G__6081 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__6081__delegate.call(this,x,rest);};
G__6081.cljs$lang$maxFixedArity = 1;
G__6081.cljs$lang$applyTo = (function (arglist__6082){
var x = cljs.core.first(arglist__6082);
var rest = cljs.core.rest(arglist__6082);
return G__6081__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__6083){
...
;
var p1_6084 = cloact.core.partial.call(null,cljs.core.vector,1,2);if(cljs.core._EQ_.call(null,p1_6084.call(null,3),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,2,3], null)))
{} else
...
if(cljs.core._EQ_.call(null,p1_6084,cloact.core.partial.call(null,cljs.core.vector,1,2)))
{} else
...
if(cljs.core.ifn_QMARK_.call(null,p1_6084))
{} else
...
if(cljs.core._EQ_.call(null,cloact.core.partial.call(null,cljs.core.vector,1,2),p1_6084))
{} else
...
if(cljs.core.not_EQ_.call(null,p1_6084,cloact.core.partial.call(null,cljs.core.vector,1,3)))
{} else
